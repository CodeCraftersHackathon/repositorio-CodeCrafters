export const ToolTip = ({ orientation = "t", bgColor, borderColor, iconColor, text, icon }) => {
    ...
    const positionClasses = {
        t: 'left-1/2 bottom-7 -translate-x-1/2 translate-y-0',  // Top
    ...
    const arrowClasses = {
        ...
        r: 'right-[calc(100%-0px)] top-1/2 -translate-y-1/2 translate-x-8 border-t-transparent border-l-transparent border-b-transparent',// Right
    ...
    return (
        <div className="relative flex flex-col items-center group">
            ...
            <i className={`border-separate ${iconColor} mx-1 border-2 rounded-full border-opacity-50`}>
                {icon}
            </i>
