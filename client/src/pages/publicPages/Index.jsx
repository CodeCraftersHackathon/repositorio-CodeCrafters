            ...
            <div className="">
                <div className="flex flex-col h-full min-h-screen w-full" >
                    ...
                    <main className={` bg-blue-900 min-w-screen z-10  justify-center items-center'}`}>
                        ...
                        <div id="herramientas" className='md:bg-gradient-to-b md:from-white md:to-blue-950 flex bg-white py-10 w-full min-h-screen  justify-center herramientas'>
                            <div className="text-center flex flex-col w-100">
                                ...
                                <div className='flex justify-center w-full p-10 rounded-md bg-transparent'>
                                    <div className="grid sm:grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-5 items-center">
                                        ...
                                        <div className='col-span-3 justify-center flex gap-x-5'>
